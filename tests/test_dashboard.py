...
class DashboardTests(unittest.TestCase):
    ...
    def test_home_endpoint_serves_dashboard(self) -> None:
        ...
        self.assertIn(b"Configuration Center", response.data)
        self.assertIn(b"config-categories", response.data)
        self.assertIn(b"config-settings", response.data)
        self.assertIn(b"Preview changes", response.data)
        self.assertIn(b"Save & Restart", response.data)
        self.assertIn(b"/api/metrics/decisions", response.data)
        self.assertIn(b"/api/config", response.data)
