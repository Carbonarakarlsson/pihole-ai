...
CONFIG_SCHEMA: tuple[ConfigItem, ...] = (
    ...
    _item("ollama_url", "PIHOLE_AI_OLLAMA_URL", "http://127.0.0.1:11434", ConfigValueType.URL, "Ollama API URL.", "Ollama and AI", _url_validator, RestartImpact.ENGINE, sensitivity=ConfigSensitivity.SENSITIVE, export_policy=ConfigExportPolicy.SECURE, services=(ENGINE_SERVICE,)),
    _item("ollama_model", "PIHOLE_AI_OLLAMA_MODEL", "llama3.2:1b", ConfigValueType.OLLAMA_MODEL, "Ollama model name.", "Ollama and AI", _model_validator, RestartImpact.ENGINE, services=(ENGINE_SERVICE,)),
